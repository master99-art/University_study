...
//从linux接收并解析数据到参数地址中
extern int usartReceiveOneData(USART_TypeDef* USARTx,int16_t *p_leftSpeedSet,int16_t *p_rightSpeedSet,int16_t *p_frontSteerAngleSet,unsigned char *p_crtlFlag);   
