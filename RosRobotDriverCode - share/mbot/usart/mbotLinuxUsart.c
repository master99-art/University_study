...
返回  值：无特殊意义
**************************************************************************/
int usartReceiveOneData(USART_TypeDef* USARTx,int *p_leftSpeedSet,int *p_rightSpeedSet,int *p_frontSteerAngleSet,unsigned char *p_crtlFlag)
{
		...
		switch(USARTBufferIndex)
		{
			...
			case 3://接收信息尾
				...
				else if (k==1)
				{
					...
					*p_frontSteerAngleSet = (int)frontSteerAngleSet.d;
